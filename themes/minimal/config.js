window.BibleThemeRegistry.register({
    ...
    defaults: { fontFamily: 'Open Sans, Arial, sans-serif', fontSize: 40, textColor: '#ffffff', backgroundColor: '#0d1117', backgroundOpacity: 58, textX: 50, textY: 56, textAlign: 'center', lineHeight: 1.3, padding: 22, maxWidth: 1240, textEffect: 'none' },
