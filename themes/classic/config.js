window.BibleThemeRegistry.register({
    ...
    defaults: { fontFamily: 'Merriweather, Georgia, serif', fontSize: 38, textColor: '#ecf0f1', backgroundColor: '#2c3e50', backgroundOpacity: 94, textX: 50, textY: 42, textAlign: 'left', lineHeight: 1.42, padding: 28, maxWidth: 1240, textEffect: 'shadow' },
